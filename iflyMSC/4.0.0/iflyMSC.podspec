...
Pod::Spec.new do |s|
  ...
  s.source_files  = 'lib/*'
  s.frameworks    = 'Foundation', 'CoreGraphics', 'UIKit' ,'AVFoundation','SystemConfiguration','CoreTelephony','AudioToolbox','CoreLocation','Contacts','AddressBook','QuartzCore','libz','libc++'
